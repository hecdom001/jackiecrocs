...
function InventoryRow({
  ...
  const originalPrice = Number(item.price_mxn ?? 0);
  const parsedLocalPrice = Number(localPrice || 0);
      ...
      <tr className="hover:bg-slate-50/70">
        ...
        <td className="px-3 py-2 align-top text-right text-slate-900 text-xs">
          <input
              ...
              className="w-28 text-right border border-slate-300 bg-white rounded-lg px-2 py-1 text-[11px] text-slate-900 focus:outline-none focus:ring-1 focus:ring-emerald-400"
          />
          <div className="mt-1 text-[10px] text-slate-500">MXN</div>
        </td>
