            ...
            <div className="mx-auto w-full max-w-screen-2xl px-4 sm:px-6 lg:px-8">
              ...
              Aguuacatito<span className="text-emerald-600">.shop</span>
                    ...
                    <div className="flex flex-1 sm:flex-none justify-end items-center gap-2">
                        ...
                        {/* Language (mobile – replaces cart) */}
                        <div className="sm:hidden rounded-full border border-slate-200 bg-white p-1 shadow-sm">
                            <button
                                type="button"
                                onClick={() => setLang("es")}
                        ...
                        <button
                            type="button"
                            onClick={onCartClick}
                            className="hidden sm:inline-flex relative items-center gap-2 rounded-2xl border border-slate-200 bg-white px-3 py-2 text-[12px] font-extrabold text-slate-900 shadow-sm hover:bg-slate-50"
