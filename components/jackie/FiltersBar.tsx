...
import { formatSizeLabel, translateColor, t } from "@/lib/jackieCatalogUtils";
    ...
    return (
        <section className="mx-auto max-w-6xl px-4 pt-4">
            <div className="rounded-3xl bg-white border border-slate-200 shadow-sm p-4 space-y-3">
              ...
              · {loading ? t(lang, "Cargando…", "Loading…") : t(lang, `${totalPairsFiltered} pares`, `${totalPairsFiltered} pairs`)}
            </span>
                    </p>
